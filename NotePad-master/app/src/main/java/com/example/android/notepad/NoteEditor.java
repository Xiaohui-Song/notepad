...
public class NoteEditor extends Activity {
    ...
    public static final int COLOR_1 = 0x111;
    public static final int COLOR_2 = 0x112;
    public static final int COLOR_3 = 0x113;

    public static final int FONT_12 = 0x114;
    public static final int FONT_16 = 0x115;
    public static final int FONT_20 = 0x116;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //在note编辑的onCreateOptionsMenu函数里添加标题
